...
class TestDeveloperHub(BaseTest):
    ...
    def test_that_deletes_app(self, mozwebqa_devhub_logged_in, free_app):
        ...
        app_status_page = dev_home.go_to_app_status_page(free_app)
        Assert.contains(free_app.name, app_status_page.page_title)
    ...
    def test_that_checks_required_field_validations_on_device_types_for_hosted_apps(self, mozwebqa_devhub_logged_in):
        dev_home = Home(mozwebqa_devhub_logged_in)
